...
CREATE TABLE IF NOT EXISTS awards (
    ...
    redemption_enabled TINYINT(1) NOT NULL DEFAULT 0 COMMENT '是否展示到积分商城',
    redemption_points_price BIGINT UNSIGNED NULL COMMENT '兑换所需积分，仅兑换商品设置',
    ...
    KEY idx_awards_redemption_shelf (redemption_enabled, status, available_stock),
