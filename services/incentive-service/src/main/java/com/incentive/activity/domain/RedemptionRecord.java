...
public class RedemptionRecord {
  ...
  public RedemptionRecord(IncentiveActivity activity, ParticipationRule rule, RedemptionItem item,
      Long userId, String eligibilityResult, Long pointTransactionId, Instant now) {
