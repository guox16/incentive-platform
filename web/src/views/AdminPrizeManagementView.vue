...
import type { ApiError, CreatePrizeRequest, PrizeResponse, PrizeStatus, PrizeType, UpdatePrizeRequest } from '../api/types';
...
<template>
  ...
  <div class="admin-page">
    <aside class="admin-nav"><a class="admin-brand" href="/admin/prizes"><b>偶</b><span>偶得 · 管理端</span></a><p>运营管理</p><a class="nav-link active" href="/admin/prizes"><i>✦</i>奖品管理</a><a class="nav-link muted" href="/lottery"><i>◇</i>返回用户端</a><div class="nav-foot">本地受信管理端<br><strong>奖品与库存维护</strong></div></aside>
