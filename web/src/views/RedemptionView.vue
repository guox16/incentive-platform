    ...
    <main class="redemption-workspace" aria-live="polite">
      ...
      <template v-else>
        <header class="redeem-heading">
          <div><p>进行中的兑换活动</p><h1>{{ activity.name }}</h1><span>确认兑换后，将从您的账户扣除相应积分。</span></div>
